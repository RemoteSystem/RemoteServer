                ...
                <ContentTemplate>
                    ...
                    <div style="float: left; width: 39%;">
                        <asp:Table runat="server" Height="100%">
                            ...
                            <asp:TableRow Height="30px">
                                <asp:TableCell VerticalAlign="Middle" ColumnSpan="2">
                                    产品类型<asp:DropDownList runat="server" AutoPostBack="true" ID="cbxDeviceType" Width="100px" />
                        ...
                        <asp:GridView runat="server" ID="gdDeviceList" AutoGenerateColumns="False" CellPadding="4" AllowPaging="true" PageSize="10"
                            ...
                            OnRowDataBound="gdDeviceList_RowDataBound" PagerSettings-Mode="Numeric" EmptyDataText="没有记录！" Width="90%">
                    ...
                    <div style="width: 60%; margin-right: 1px; float: right; overflow-y:auto;">
                        <asp:Panel ID="DeviceDetialPanel" Height="550px" Width="100%" runat="server" ScrollBars="Vertical">
                            <asp:Table runat="server" Width="98%">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell ColumnSpan="2">
                                    <asp:Table runat="server" Width="100%" Visible="false">
                                        <asp:TableRow>
