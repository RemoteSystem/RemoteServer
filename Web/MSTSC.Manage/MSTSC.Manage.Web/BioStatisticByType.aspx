<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BioStatisticByType.aspx.cs" Inherits="MSTSC.Manage.Web.BioStatisticByType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'BioStatisticByType.aspx/getDeviceList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'BioStatisticByType.aspx/getDeviceList' });
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "生化仪统计-按机型", noNumricColumns: [1]
            });
        }
    </script>
</asp:Content>
