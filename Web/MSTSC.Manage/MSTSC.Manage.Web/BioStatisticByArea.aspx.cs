...
{
    public partial class BioStatisticByArea : BasePage
    {
        [WebMethod]
        public static string getDeviceList(string conditions, int rows, int page, string sort, string sortOrder)
        {
            ...
            DataTable dt = bll.BioStatisticsByAreaBLL(conditionModel, pagerInfo, sortInfo);
            pagerInfo.RecordCount = bll.getAreaBioDeviceCount(conditionModel);
