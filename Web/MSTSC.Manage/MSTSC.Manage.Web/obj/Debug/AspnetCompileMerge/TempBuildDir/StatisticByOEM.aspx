<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StatisticByOEM.aspx.cs" Inherits="MSTSC.Manage.Web.StatisticByOEM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'StatisticByOEM.aspx/getDataList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'StatisticByOEM.aspx/getDataList' });
