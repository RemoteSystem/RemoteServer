<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BioStatisticByArea.aspx.cs" Inherits="MSTSC.Manage.Web.BioStatisticByArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'BioStatisticByArea.aspx/getDeviceList';
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "生化仪统计-按装机区域", noNumricColumns: [1]
            });
        }
    </script>
</asp:Content>
