        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 id="modifyTitle" class="modal-title">新增用户</h5>
                ...
                columns: [
                    {
                        ...
                        formatter: function (value, row, index) {
                            ...
                            if (value != '1') { opt += ' <a href="javascript:void(0)" onclick="resetpwd(\'' + value + '\');return false;">重置密码</a> &nbsp;'; }
                            if (value == '1') { opt += ''; }
                            else if (row["isDel"]) {
