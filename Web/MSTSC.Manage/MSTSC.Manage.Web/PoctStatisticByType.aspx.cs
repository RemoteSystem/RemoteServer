...
{
    public partial class PoctStatisticByType : BasePage
    {
        [WebMethod]
        public static string getDeviceList(string conditions, int rows, int page, string sort, string sortOrder)
        {
            ...
            DataTable dt = bll.PoctStatisticsByTypeBLL(conditionModel, pagerInfo, sortInfo);
            pagerInfo.RecordCount = bll.getTypePoctDeviceCount(conditionModel);
