...
{
    public partial class PoctStatisticAllDevices : BasePage
    {
        [WebMethod]
        public static string getDeviceList(string conditions, int rows, int page, string sort, string sortOrder)
        {
            ...
            DataTable dt = bll.StatisticsAllPoctDevicesBLL(conditionModel, pagerInfo, sortInfo);
            pagerInfo.RecordCount = bll.getPoctDeviceCount(conditionModel);
