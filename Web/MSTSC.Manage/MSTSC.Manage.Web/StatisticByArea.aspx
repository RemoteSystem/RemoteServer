<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StatisticByArea.aspx.cs" Inherits="MSTSC.Manage.Web.StatisticByArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'StatisticByArea.aspx/getDataList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'StatisticByArea.aspx/getDataList' });
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "统计结果-按区域统计", noNumricColumns: [0]
            });
        }
    </script>
</asp:Content>
