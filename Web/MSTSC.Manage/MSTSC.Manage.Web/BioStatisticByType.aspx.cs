...
{
    public partial class BioStatisticByType : BasePage
    {
        [WebMethod]
        public static string getDeviceList(string conditions, int rows, int page, string sort, string sortOrder)
        {
            ...
            DataTable dt = bll.BioStatisticsByTypeBLL(conditionModel, pagerInfo, sortInfo);
            pagerInfo.RecordCount = bll.getTypeBioDeviceCount(conditionModel);
