<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PoctStatisticAllDevices.aspx.cs" Inherits="MSTSC.Manage.Web.PoctStatisticAllDevices" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnExportyb').click(function () {
                window.open("Export.ashx?Action=poct_all&model=" + $("#selModel").val() + "&sn=" + $("#sn").val() + "&card=" + $("#card").val(), "_blank");
                //window.location.href = "Export.ashx?Action=poct_all&model=" + $("#selModel").val();
            });
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'PoctStatisticAllDevices.aspx/getDeviceList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'PoctStatisticAllDevices.aspx/getDeviceList' });
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "POCT统计-所有机器", noNumricColumns: [1, 2, 3, 4]
            });
        }
    </script>
</asp:Content>
