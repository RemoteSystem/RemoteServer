<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PoctStatisticAll.aspx.cs" Inherits="MSTSC.Manage.Web.PoctStatisticAll" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnExportyb').click(function () {
                window.open("Export.ashx?Action=poct_all_num&model=" + $("#selModel").val() + "&sn=" + $("#sn").val() + "&card=" + $("#card").val(), "_blank");
            });
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'PoctStatisticAll.aspx/getDeviceList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'PoctStatisticAll.aspx/getDeviceList' });
        }
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "POCT统计-总量", noNumricColumns: [1, 2, 3, 4]
            });
        }
    </script>
</asp:Content>
