<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PoctStatisticByArea.aspx.cs" Inherits="MSTSC.Manage.Web.PoctStatisticByArea" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnExportyb').click(function () {
                window.open("Export.ashx?Action=poct_area&model=" + $("#selModel").val(), "_blank");
            });
        ...
        function InitMainTable() {
            ...
            var queryUrl = 'PoctStatisticByArea.aspx/getDeviceList';
        ...
        function freshTable() {
            type = 1;
            $table.bootstrapTable('refreshOptions', { pageNumber: 1, url: 'PoctStatisticByArea.aspx/getDeviceList' });
        }
        ...
        function exportExcel() {
            $("#grid").tableExport({
                type: "excel", escape: "true", fileName: "POCT统计-按装机区域", noNumricColumns: [1]
            });
        }
    </script>
</asp:Content>
